...
The project uses [ruff](https://docs.astral.sh/ruff/) for linting. Maximum line length is **120 characters**.
...
The lint check runs automatically on every PR. A PR with lint errors will not be merged.
